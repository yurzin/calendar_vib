    ...
    <aside class="al-sidebar">
      <div class="al-sidebar-top">
        ...
        <nav class="al-nav">
          ...
          <router-link to="/archive" class="al-nav-item" active-class="al-nav-item--active">
            <svg viewBox="0 0 20 20" fill="none" width="16" height="16">
              <path d="M3 6l1-3h12l1 3M3 6v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V6M3 6h14" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M8 10h4" stroke="currentColor" stroke-width="1.3" stroke-linecap="round"/>
            </svg>
            <span>Архив</span>
          </router-link>

          <router-link to="/slider" class="al-nav-item" active-class="al-nav-item--active">
            <svg viewBox="0 0 20 20" fill="none" width="16" height="16">
              <rect x="2" y="4" width="16" height="12" rx="2" stroke="currentColor" stroke-width="1.3"/>
              <path d="M2 13l4-4 3 3 4-5 5 6" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            <span>Слайдер</span>
          </router-link>
