  ...
  <div class="gl-section gl-section--dark" id="business-partner">
    <div class="gl-container">
      <div class="gl-section-head">
        ...
        <p class="gl-section-body">4 знаменательные даты, 1 размещение макета в календарной сетке и 1 макет на странице месяца.</p>
      </div>
            ...
            <div class="calendar-col" v-for="(col, ci) in columns" :key="ci">
              ...
              >
                ...
                <div v-if="day && isSpecialDay(day.date)" class="special-tooltip">
                  <span class="special-tooltip-count">4 размещения</span>
      ...
      <PartnerTiersNav current="business-partner"/>
    </div>
  </div>
</template>
