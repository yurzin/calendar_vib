<template>
  <div class="gl-section gl-section--dark" id="project-participant">
    <div class="gl-container">
      <div class="gl-section-head">
        ...
        <div class="gl-section-head-top">
          <div class="gl-section-head-main">
            <h2 class="gl-section-title">Участник проекта</h2>
          </div>
          <div class="gl-section-price">
            <span class="gl-section-price-lbl">Стоимость участия</span>
            <span class="gl-section-price-val">5 990 ₽</span>
          </div>
          <div class="gl-section-headline">
            Ваше имя <span class="gl-section-headline-accent">в указателе года</span>
          </div>
        </div>
        <p class="gl-section-body">2 знаменательные даты, 1 мини-макет в календарной сетке и 1 макет на странице месяца.</p>
      </div>
      ...
      <div class="grid-wrapper">
        <div class="grid-header">
          <div class="month-selector">
            ...
            <span class="current-month">{{ currentPageInfo.type === 'ad' ? currentPageInfo.adName : pageLabel }}</span>
          ...
          <div class="ad-right">
            ...
            <div class="ad-logo-area">
              <div class="ad-logo-mark">
                <svg width="70" height="70" viewBox="0 0 14 14" fill="none">
              ...
              <span class="ad-logo-name">Ваша<br>организация</span>
            </div>
            ...
            <div class="calendar-col" v-for="(col, ci) in columns" :key="ci">
              ...
              >
                ...
                <div v-if="day && isSpecialDay(day.date)" class="special-tooltip">
                  <span class="special-tooltip-count">2 размещения</span>
                ...
                <div v-if="!day && isPlacementFirst(rowIdx, ci)" class="placement-tooltip">
                  <span class="placement-tooltip-count">1 размещение</span>
                  Мини-макет компании на странице календаря
                </div>
              </div>
            </div>
          </div>
      ...
      <PartnerTiersNav current="project-participant"/>
    </div>
  </div>
</template>
...
import PartnerTiersNav from '@/views/Pages/View/Components/PartnerTiersNav.vue'
...
// У делового партнёра нет обложки: сразу январь, затем для каждого месяца —
...
.ad-placement-marker::after {
  content: '◆';
  font-size: 12px;
  color: #ec4899;
}

.ad-placement-marker:hover .placement-tooltip {
  display: block;
}

/* Маркер у верхнего края страницы — тултип раскрывается вниз, а не вверх */
.ad-placement-marker .placement-tooltip {
  top: calc(100% + 8px);
  bottom: auto;
  left: auto;
  right: 0;
...
.ad-placement-marker .placement-tooltip::after {
  top: auto;
  bottom: 100%;
  left: auto;
  right: 10px;
